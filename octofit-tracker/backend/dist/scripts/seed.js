...
async function seedDatabase() {
    try {
        ...
        await Promise.all([
            fitness_1.User.deleteMany({}),
            fitness_1.Team.deleteMany({}),
            fitness_1.Activity.deleteMany({}),
            fitness_1.LeaderboardEntry.deleteMany({}),
            fitness_1.Workout.deleteMany({}),
        ]);
        const users = await fitness_1.User.insertMany([
            {
                name: 'Ava Thompson',
        ...
        await fitness_1.Team.insertMany([
            {
                name: 'Blue Hawks',
                sport: 'Cross Country',
        ...
        await fitness_1.Activity.insertMany([
            {
                user: 'Ava Thompson',
                type: 'Running',
                durationMinutes: 42,
        ...
        await fitness_1.LeaderboardEntry.insertMany([
        ...
        await fitness_1.Workout.insertMany([
            {
